...
//        Log.d(TAG, "projection view is =" + Arrays.toString( matrixGrabber.mProjection ));
        ...
        int result = GLU.gluUnProject(winx, winy, 1.0f, mModelView, 0, mProjection, 0, viewport, 0, temp, 0);
        ...
        result = GLU.gluUnProject(winx, winy, 0, mModelView, 0, mProjection, 0, viewport, 0, temp, 0);
        Matrix.multiplyMV(temp2,0,mModelView, 0, temp, 0);
        if(result == GL10.GL_TRUE){
